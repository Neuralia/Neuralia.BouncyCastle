...
namespace Neuralia.BouncyCastle.extra.pqc.crypto.Chacha {
		...
		: Salsa20Engine2
	{
		...
		public ChaChaEngine2(int rounds)
			: base(rounds)
		{
		}
		...
		protected override void SetKey(ByteArray keyBytes, ByteArray ivBytes)
		{
            if (keyBytes != null)
            {
                ...
                // Key
                Pack.LE_To_UInt32(keyBytes.Bytes, keyBytes.Offset, engineState, 4, 4);
                Pack.LE_To_UInt32(keyBytes.Bytes, keyBytes.Offset + keyBytes.Length - 16, engineState, 8, 4);
            }

            // IV
            Pack.LE_To_UInt32(ivBytes.Bytes, ivBytes.Offset, engineState, 14, 2);
		}
